 ...
 * @version 3.0
 */
public class DerivativeFinding {

    /**
     * Polynomial from the input.
     */
    private Polynomial inPolynomial;

    public DerivativeFinding() {
        inPolynomial = null;
    }
     ...
     */
    public DerivativeFinding(Polynomial aPolynomial) {
        inPolynomial = aPolynomial;
    }

    public void setDerivativeFinding(Polynomial aPolynomial) {
        inPolynomial = aPolynomial;
    }
